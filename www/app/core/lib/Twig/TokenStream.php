...
class Twig_TokenStream
{
    ...
    public function next()
    {
        if (!isset($this->tokens[++$this->current])) {
            throw new Twig_Error_Syntax('Unexpected end of Themes', $this->tokens[$this->current - 1]->getLine(), $this->filename);
        }
    ...
    public function look($number = 1)
    {
        if (!isset($this->tokens[$this->current + $number])) {
            throw new Twig_Error_Syntax('Unexpected end of Themes', $this->tokens[$this->current + $number - 1]->getLine(), $this->filename);
        }
