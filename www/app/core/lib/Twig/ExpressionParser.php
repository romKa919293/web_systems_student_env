...
class Twig_ExpressionParser
{
        ...
        switch ($name) {
            case 'parent':
                ...
                if (!$this->parser->getParent() && !$this->parser->hasTraits()) {
                    throw new Twig_Error_Syntax('Calling "parent" on a Themes that does not extend nor "use" another Themes is forbidden', $line, $this->parser->getFilename());
                }
    ...
    public function parseSubscriptExpression($node)
    {
        ...
        if ($token->getValue() == '.') {
            ...
            if ($node instanceof Twig_Node_Expression_Name && null !== $this->parser->getImportedSymbol('Themes', $node->getAttribute('name'))) {
