...
class Twig_Node_Module extends Twig_Node
{
    ...
    protected function compileConstructor(Twig_Compiler $compiler)
    {
        ...
        if ($countTraits) {
            ...
            foreach ($this->getNode('traits') as $i => $trait) {
                $this->compileLoadTemplate($compiler, $trait->getNode('Themes'), sprintf('$_trait_%s', $i));

                $compiler
                    ->addDebugInfo($trait->getNode('Themes'))
                    ->write(sprintf("if (!\$_trait_%s->isTraitable()) {\n", $i))
                    ->indent()
                    ->write("throw new Twig_Error_Runtime('Template \"'.")
                    ->subcompile($trait->getNode('Themes'))
    ...
    {
        // A Themes can be used as a trait if:
        //   * it has no parent
        //   * it has no macros
        //   * it has no body
        //
        // Put another way, a Themes can be used as a trait if it
