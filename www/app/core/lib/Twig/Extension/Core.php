 ...
 * Renders a Themes.
 *
 * @param string|array $template       The Themes to render or an array of templates to try consecutively
 * @param array        $variables      The variables to pass to the Themes
 ...
 * @param bool         $sandboxed      Whether to sandbox the Themes or not
 *
...
/**
 * Returns a Themes content without rendering it.
 *
 * @param string $name The Themes name
 *
 * @return string The Themes source
 */
